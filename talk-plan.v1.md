...
- **Data & Delete Files**: Parquet/ORC/Avro файлы с данными и файлы удалений (Position/Equality Deletes).
...
- **Пошаговый разбор**:
    1. **Init**: Создание таблицы `taxi_dataset` и осмотр структуры (`metadata/`, `data/`).
